...
namespace Omi.Modules.Dbgroup.WebsiteSetting.ViewModels
{
    public partial class WebsiteSettingViewModel
    {
        ...
        [EntitySettingValue(Name = "ConstructionBannerImage")]
        public SettingValueViewModel ConstructionBannerImage { get; set; }
    ...
    public partial class WebsiteSettingViewModel
    {
        public static WebsiteSettingViewModel FromEntity(SettingEntity entity)
        {
            ...
            var constructionBannerImage = entity.SettingValues.FirstOrDefault(o => o.Name == "ConstructionBannerImage");
            ...
            return new WebsiteSettingViewModel
            {
                ...
                ConstructionBannerImage = SettingValueViewModel.FromEntity(constructionBannerImage),
