...
import { AdminRootState, WebsiteSettingFormValue } from '../../../Types'
...
class WebsiteSettingForm extends React.Component<OwnProps & StateProps & DispatchProps> {
            ...
            <Card noHovering>
                ...
                <Form onSubmit={this.handleSubmit}>
                    <Tabs defaultActiveKey="1" tabBarExtraContent={operations}>
                        ...
                        {this.renderConstructionSetting()}
    ...
    renderConstructionSetting() {
        return (
            <Tabs.TabPane tab="Construction Page" key="2">
                <Row gutter={30}>
                    <Col span={8}>
                        <fieldset>
                            {this.props.form.getFieldDecorator(nameof.full<WebsiteSettingFormValue>((o) => o.constructionBannerImage.id), {
                                initialValue: this.props.formValue.constructionBannerImage.id
                            })(<Input type="hidden" />)}
                            {this.props.form.getFieldDecorator(nameof.full<WebsiteSettingFormValue>((o) => o.constructionBannerImage.name), {
                                initialValue: this.props.formValue.constructionBannerImage.name
                            })(<Input type="hidden" />)}
                            <Form.Item label="Background image">
                                {this.props.form.getFieldDecorator(nameof.full<WebsiteSettingFormValue>((o) => o.constructionBannerImage.value), {
                                    initialValue: this.props.formValue.constructionBannerImage.value
                                })(<AvatarSelect />)}
                            </Form.Item>
                        </fieldset>
                    </Col>
